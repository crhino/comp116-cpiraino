...
set1.pcap:
  ...
  2. The protocol used to transfer files was FTP.
  3. FTP sends everything over plain-text, meaning anyone can see it.
  4. Transfer files with SFTP, SSH File Transfer Protocol.
  5. The IP address is 67.23.79.113.
  6. The username was "stokerj" and the password was "w00tfu!".
  7. 3 files were transfered.
  8. The names of the files are: code.rtf, secret.pdf, acb.jpg.

set2.pcap:

  10. There are 74566 packets in this set.
  11. I found 5 username-password pairs, two of which where tried in the same stream.
  12. I used Wireshark and the find packet utility to search for packets with the string
      "pass" or "user" in the info.
  13. 
      User: cisco Password: chris10 Protocol: TCP/Telnet Server IP: 200.60.70.1 Domain Name: Port: 23
      User: cisco Password: chelita Protocol: TCP/Telnet Server IP: 200.60.70.1 Domain Name: Port: 23
      User: e129286 Password: 4.Ekkama Protocol: POP Server IP: 144.122.144.179 Domain Name: Port: 110
      User: mbergeson@hjnew.com Password: mb123on Protocol: POP Server IP: 67.128.149.178 Domain Name: Port: 110
      User: brewer Password: 1qazxsw209simona12 Protocol: POP Server IP: 62.173.185.22 Domain Name: Port: 110

  14. Two of the user-password combinations are valid: users - mbergeson@hjnew.com and brewer.
  15. I found this out by looking at the TCP streams of each of the user-password combinations.
  16. It is illegal.
  17. Log in through ssh or a VPN offsite so that no one could sniff it in the clear.
  18. I found the domain and hostnames by using the "Show Address Resolution" option in Wireshark:
